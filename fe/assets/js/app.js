...
/** JSEncrypt.sign/verify membutuhkan CryptoJS.SHA256 */
function getRsaHasher() {
    if (typeof CryptoJS !== 'undefined' && CryptoJS.SHA256) {
        return CryptoJS.SHA256;
    }
    throw new Error('CryptoJS belum dimuat. Pastikan koneksi internet aktif lalu muat ulang halaman.');
}
